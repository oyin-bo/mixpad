...
export const HTMLAttributeEquals = 0x1500000;
export const HTMLAttributeValue = 0x1600000;

// HTML Comment Tokens
export const HTMLCommentOpen = 0x1700000;
export const HTMLCommentContent = 0x1800000;
export const HTMLCommentClose = 0x1900000;

// HTML CDATA Tokens
export const HTMLCDataOpen = 0x1A00000;
export const HTMLCDataContent = 0x1B00000;
export const HTMLCDataClose = 0x1C00000;

// HTML DOCTYPE Tokens
export const HTMLDocTypeOpen = 0x1D00000;
export const HTMLDocTypeContent = 0x1E00000;
export const HTMLDocTypeClose = 0x1F00000;

// XML Processing Instruction Tokens
export const XMLProcessingInstructionOpen = 0x2000000;
export const XMLProcessingInstructionTarget = 0x2100000;
export const XMLProcessingInstructionContent = 0x2200000;
export const XMLProcessingInstructionClose = 0x2300000;
