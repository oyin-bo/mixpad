...
/**
 * Scan raw text content for textarea elements.
 ...
 * but entities are still recognized. This scanner does not have the recovery
 * logic for '<' or double newlines that is present in scanHTMLRawText.
 * 
 ...
 */
export function scanTextarea(input, start, end, tagNameStart, tagNameLength, output) {
  let offset = start;
